...
namespace Rebus.LegacyCompatibility
{
    /// <summary>
    ...
    class CustomJsonSerializer : ISerializer
    {
        ...
        internal CustomJsonSerializer(Encoding encoding)
            : this(DefaultSettings, encoding)
        {
        }

        internal CustomJsonSerializer(JsonSerializerSettings jsonSerializerSettings)
            : this(jsonSerializerSettings, DefaultEncoding)
        {
        }

        internal CustomJsonSerializer(JsonSerializerSettings jsonSerializerSettings, Encoding encoding)
        {
